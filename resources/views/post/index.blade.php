                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            <form action="{{ route('posts.destroy', $post->id) }}" method="POST">
                                ...
                                <button type="submit" class="btn btn-link">
                                    <img src="{{ asset('icons/icons8-full-trash-32.png') }}" alt="Delete">
                                </button>
                            </form>
                        ...
                        <ul class="list-unstyled">
                            @foreach ($post->comments as $comment)
                                <li class="media mb-3">
                                    <img src="{{ asset('img/momoland.jpeg') }}" class="mr-3 rounded-circle" alt="Commenter Picture" style="width: 40px;">
